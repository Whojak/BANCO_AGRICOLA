...
<head>
    ...
    <title>Movimientos Sucursal</title>
</head>
...
<body>
    ...
    <div class="container">
        <h2 class="text-4xl font-extrabold dark:text-white">Movimientos por sucursal</h2>
    </div>
    ...
    <div class="container">
        ...
        <form class="flex items-center max-w-sm mx-auto">
            ...
            <div class="relative w-full">
                ...
                <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar por sucursal" />
            </div>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3">Movimiento</th>
                        <th scope="col" class="px-6 py-3">Tipo de transaccion</th>
                        <th scope="col" class="px-6 py-3">Estado</th>
                        <th scope="col" class="px-6 py-3">Fecha inicial</th>
                        <th scope="col" class="px-6 py-3">Fecha terminal</th>
    ...
    INNER JOIN socursal s ON u.id_socursal = s.id
    ORDER BY m.id DESC";
            ...
            <td class="px-6 py-4">' . $row["nombre_sucursal"] . '</td>
        </tr>';
                    }
