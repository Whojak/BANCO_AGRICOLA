...
<div class="container">
    <h2 class="text-4xl font-extrabold dark:text-white">Desemplear</h2>
</div>
              ...
              <?php 
					...
					$sql = ('SELECT u.id, u.nombre, u.apellido, u.dui, u.numero_tel, u.correo, u.usuario, u.estado, u.rol,
                            ...
                            u.id_socursal, u.fecha_creacion  
                                ...
                                WHERE u.estado = "Activo" AND  u.id_tipo = "2" ORDER BY u.id DESC; ');
					foreach ($pdocn->query($sql) as $row) {
						echo 	'<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4">
                                     <form method="post">
                                    <button type="submit" name="despedir" value="' . $row["id"] . '" class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Despedir</button>
                                    </form>
                                    </td>' ;		
                                    } ?>		
