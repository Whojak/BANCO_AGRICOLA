...
<body>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <li>
                        <a href="../index.php" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:dark:text-blue-500">Logout</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container">
        <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Gerente de Banco</span></h1>
    ...
    <div class="container">
        <div class="card">
            <div class="card-content">
                <h5>Acciones de Gerente de sucursal</h5>

                <a href="acciones_gerente.php">Ingresar</a>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-content">
                ...
                <a href="crear_sucursal.php">Crear</a>
            </div>
        </div>

        <div class="card">
            <div class="card-content">
                <h5>Movimientos de sucursales
                </h5>
