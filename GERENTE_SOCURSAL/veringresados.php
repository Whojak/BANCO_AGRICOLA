...
<head>
    ...
    <script src="Validations/buscadorinput.js"></script>
   
    <title>Empleados ingresados</title>
</head>
...
<div class="container">
    <h2 class="text-4xl font-extrabold dark:text-white">Empleados ingresados</h2>
</div>
...
<form class="flex items-center max-w-sm mx-auto">   
    ...
    <div class="relative w-full">
        ...
        <input type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Buscar por usuario"  />
    </div>
			    ...
			    include 'Connection/connection.php';
					...
					$sql = ('SELECT u.id, u.nombre, u.apellido, u.dui, u.numero_tel, u.correo, u.usuario, u.estado, u.rol,
                            ...
                            u.id_socursal, u.fecha_creacion  
                                ...
                                WHERE u.estado = "Espera de aprobacion" ORDER BY u.id DESC; ');
...
<br>
        ...
        <div class="container"> 
            <a href="ingresar.php" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">  <button  type="button" class="py-2.5 px-5 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Volver</button> </a>
